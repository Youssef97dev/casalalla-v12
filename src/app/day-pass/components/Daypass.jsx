...
const Daypass = () => {
  ...
  return (
    <>
      <div className="w-full h-screen text-center flex flex-col justify-center items-center gap-8 px-3 lg:px-40 py-5 lg:py-28 text-secondary ">
        ...
        <button
          ...
          className="text-[15px] px-16 py-4 lg:py-7 border border-secondary rounded mt-5 lg:mt-20 hover:bg-secondary hover:text-white transition-all duration-100"
        >
          BOOK DAY PASS
        </button>
      </div>
